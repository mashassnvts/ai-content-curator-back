...
const HELP_TEXT =
    ...
    '• Нажимайте кнопки внизу, чтобы управлять интересами и режимами.\n' +
    '• \"🔍 Проанализировать ссылку\" — отправьте URL после нажатия кнопки.\n' +
    '• \"➕ Добавить интерес\" — напишите темы через запятую.\n' +
    '• Можно просто отправить ссылку без кнопок — я попробую её проанализировать.\n' +
    '• Команда /mode переключает между гостевым и синхронным режимом.';
